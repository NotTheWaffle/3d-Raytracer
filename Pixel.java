public class Pixel {
	...
	public void addSample(int[] color){
		this.runningColor[0] = (this.runningColor[0] * this.samples + color[0]) / (this.samples + 1);
		this.runningColor[1] = (this.runningColor[1] * this.samples + color[1]) / (this.samples + 1);
		this.runningColor[2] = (this.runningColor[2] * this.samples + color[2]) / (this.samples + 1);
		this.samples ++;
	}
